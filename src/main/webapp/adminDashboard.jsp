...
<body>
    ...
    <div class="main-content">
        ...
        <div class="welcome-banner">
            ...
            <p>Manage drivers, passengers, bookings, and reports with ease from your admin dashboard.</p>
        </div>
        ...
        <div class="admin-actions">
            <div class="action-card">
                ...
                <div class="action-title">Driver Details</div>
                <div class="action-desc">View and manage driver profiles, schedules, and performance.</div>
                <a href="driverDetails.jsp" class="action-btn">Manage Drivers</a>
            </div>
            <div class="action-card">
                <div class="action-icon"><i class="fas fa-users"></i></div>
                <div class="action-title">Passenger Details</div>
                <div class="action-desc">Access passenger information and account details.</div>
                <a href="passengerDetails.jsp" class="action-btn">View Passengers</a>
            </div>
            <div class="action-card">
                <div class="action-icon"><i class="fas fa-calendar-check"></i></div>
                <div class="action-title">Booking Management</div>
                <div class="action-desc">Oversee all bookings, approve, or cancel as needed.</div>
                <a href="bookingManagement.jsp" class="action-btn">Manage Bookings</a>
            </div>
            <div class="action-card">
                <div class="action-icon"><i class="fas fa-chart-bar"></i></div>
                <div class="action-title">Generate Reports</div>
                <div class="action-desc">Create detailed reports on rides, revenue, and more.</div>
                <a href="reportGeneration.jsp" class="action-btn">Generate Reports</a>
            </div>
        </div>
    </div>
